...
function sh(a){a.T||(a.T=.01>a.Dc()?"https://web.archive.org/web/20221213090405/https://www.google.com/log?format=json&hasfast=true":"https://web.archive.org/web/20221213090405/https://play.google.com/log?format=json&hasfast=true");return a.T}
...
;function Bh(){this.j="https://web.archive.org/web/20221213090405/https://play.google.com/log?format=json&hasfast=true";this.s=!1;this.m=Ah;this.h=""}
...
b=Al("//web.archive.org/web/20221213090405/https://googleads.g.doubleclick.net/pagead/id",a)})).qb(function(c){c instanceof If&&b.abort();
return Gf(c)})}
...
function Nu(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=ib(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20221213090405/https://fonts.gstatic.com/s/")});
...
try{bw("//web.archive.org/web/20221213090405/https://static.doubleclick.net/instream/ad_status.js",b)}catch(c){}iw.push(fi.S(function(){if(!(jw||"google_ad_status"in window)){try{hw("//web.archive.org/web/20221213090405/https://static.doubleclick.net/instream/ad_status.js",b)}catch(c){}jw=!0;Sk("DCLKSTAT",3)}},5E3))}}}
...
function Lx(){Fx&&Fx.sendAbandonmentPing&&Fx.sendAbandonmentPing();L("PL_ATT")&&Yw.dispose();for(var a=fi,b=0,c=iw.length;b<c;b++)a.ea(iw[b]);iw.length=0;gw("//web.archive.org/web/20221213090405/https://static.doubleclick.net/instream/ad_status.js");jw=!1;Sk("DCLKSTAT",0);ue(Hx,Gx);Fx&&(Fx.removeEventListener("onVideoDataChange",Ix),Fx.destroy())}
...
/*
     FILE ARCHIVED ON 09:04:05 Dec 13, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:56:35 Jan 30, 2023.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 74.744 (4)
  CDXLines.iter: 22.662 (3)
  load_resource: 93.398
  PetaboxLoader3.resolve: 56.344
*/