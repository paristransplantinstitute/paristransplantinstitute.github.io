...
function sh(a){a.T||(a.T=.01>a.Dc()?"https://web.archive.org/web/20221212133448/https://www.google.com/log?format=json&hasfast=true":"https://web.archive.org/web/20221212133448/https://play.google.com/log?format=json&hasfast=true");return a.T}
...
;function Bh(){this.j="https://web.archive.org/web/20221212133448/https://play.google.com/log?format=json&hasfast=true";this.s=!1;this.m=Ah;this.h=""}
...
b=zl("//web.archive.org/web/20221212133448/https://googleads.g.doubleclick.net/pagead/id",a)})).qb(function(c){c instanceof If&&b.abort();
return Gf(c)})}
...
function Mu(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=ib(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20221212133448/https://fonts.gstatic.com/s/")});
...
try{aw("//web.archive.org/web/20221212133448/https://static.doubleclick.net/instream/ad_status.js",b)}catch(c){}hw.push(fi.S(function(){if(!(iw||"google_ad_status"in window)){try{gw("//web.archive.org/web/20221212133448/https://static.doubleclick.net/instream/ad_status.js",b)}catch(c){}iw=!0;Rk("DCLKSTAT",3)}},5E3))}}}
...
function Kx(){Ex&&Ex.sendAbandonmentPing&&Ex.sendAbandonmentPing();L("PL_ATT")&&Xw.dispose();for(var a=fi,b=0,c=hw.length;b<c;b++)a.ea(hw[b]);hw.length=0;fw("//web.archive.org/web/20221212133448/https://static.doubleclick.net/instream/ad_status.js");iw=!1;Rk("DCLKSTAT",0);ue(Gx,Fx);Ex&&(Ex.removeEventListener("onVideoDataChange",Hx),Ex.destroy())}
...
/*
     FILE ARCHIVED ON 13:34:48 Dec 12, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:56:33 Jan 30, 2023.
...
/*
playback timings (ms):
  captures_list: 375.807
  exclusion.robots: 0.096
  exclusion.robots.policy: 0.086
  cdx.remote: 0.066
  esindex: 0.009
  LoadShardBlock: 88.094 (3)
  PetaboxLoader3.resolve: 163.987 (4)
  PetaboxLoader3.datanode: 86.801 (5)
  CDXLines.iter: 20.644 (3)
  load_resource: 663.243 (2)
*/